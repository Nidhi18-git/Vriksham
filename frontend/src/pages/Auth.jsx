        ...
        <div className="container-page grid items-center gap-12 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-5 max-w-xl leading-8 text-slate-600 dark:text-slate-300">
              JWT authentication with user and admin roles keeps service requests, assignments, and operating data protected.
            </p>
          </div>
          <form onSubmit={submit} className="glass rounded-[2rem] p-8">
            {isSignup && (
              <>
                ...
                <select className="input mb-4" value={form.role} onChange={(event) => setForm({ ...form, role: event.target.value })}>
